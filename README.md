...
└── outputs/
    ...
    └── usage_log.csv        # Login and action history
```
...
10. **Usage Logging** — Every login and action is recorded to `outputs/usage_log.csv`
...
- The `outputs/usage_log.csv` file is created automatically on first run.
